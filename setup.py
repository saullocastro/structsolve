...
def write_version_py(version, is_released, filename='structsolve/version.py'):
    fullversion = get_version_info(version, is_released)
    with open("./structsolve/version.py", "wb") as f:
...
s = setup(
    ...
    url = "https://github.com/compmech/structsolve",
